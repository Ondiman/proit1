...
$productId    = 119689;   // id товара в системе
$productPrice = 0 ;   // цена товара при создании заказа
$thankUrl     = '../thanks.html'; // урл вашей страницы спасибо
...
$streamId      = 0; // id потока в системе (заказ будет привязываться к конретному потоку. полезно при настройке постбека)
...
$post = array();
$post['api_key'] = 'xQQ!A!mS8GC4bn4*@8nT';
